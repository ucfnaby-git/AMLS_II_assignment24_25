...
model_checkpoint = "A/results/mwcnn_trained.pth"  # path to trained model checkpoint
...
input_file = "Datasets/test/BenchmarkNoisyBlocksSrgb.mat"
...
output_file = "A/results/SubmitSrgb.csv"
